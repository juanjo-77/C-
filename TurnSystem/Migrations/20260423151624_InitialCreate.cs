        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Ventanilla = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Turnos_Asesores_AsesorId",
                        column: x => x.AsesorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HistorialTurnos_Turnos_TurnoId",
                        column: x => x.TurnoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialTurnos_TurnoId",
                table: "HistorialTurnos",
                column: "TurnoId");

            migrationBuilder.CreateIndex(
                name: "IX_Turnos_AsesorId",
                table: "Turnos",
                column: "AsesorId");
